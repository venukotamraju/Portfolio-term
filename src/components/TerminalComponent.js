...
const TerminalComponent = () => {
        ...
        if (
          ...
          const command =
            commandHistoryRef.current[
              commandHistoryRef.current.length - 1 - newIndex
            ];
  ...
  const projects = [
    {
      ...
      description:
        "A PERN application with modern architecture and secure APIs enabling registration and logging in of employees",
    ...
    },
    {
      ...
      description:
        "An implementation of global currency exchange units. Know what your global currency units values interms of your chosen currency.",
  ...
  const processCommand = (command, term) => {
    ...
    switch (command) {
      ...
      case "resume":
        ...
        term.write(
          `You can download my resume here: ${window.location.origin}/venu_working.pdf\r\n`
        );
        break;
      case "contact":
        ...
        term.write(
          " - LinkedIn: https://www.linkedin.com/in/venukotamraju/\r\n"
        );
  ...
  return <div ref={terminalRef} className="mt-10 mb-10" id="terminal" />;
};
